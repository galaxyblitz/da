  ...
  this.data = [
    {
      ...
      image: "assets/img/EOS423.png",
      info: [
        "Chintai is envisioned to sit alongside other EOS Essentials as a community owned dApp solution for efficient token leasing",
    ...
    },
    {
      ...
      tag: ["browser", "wallet", "secure"],
      image: "http://via.placeholder.com/1152x450",
      info: [
        "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec vel tellus ornare, vulputate mi sed, porta purus. In sit amet blandit massa. Suspendisse nisl massa, semper sed dictum.",
